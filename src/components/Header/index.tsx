...
const Header = (props: Props) => {
  ...
  const drawer = (
    <div style={{ backgroundColor: '#470024', height: '100vh'}}>
      ...
      <List>
        <ListItemButton sx={{ marginBottom: '5px', color: 'white' }} onClick={() => history.push('/')}>
          Clients
        </ListItemButton>
        <Divider sx={{backgroundColor: 'white'}} />
        <ListItemButton sx={{ marginBottom: '5px', marginTop: '5px', color: 'white' }} onClick={() => history.push('/')}>
          Bedrooms
        </ListItemButton>
        <Divider sx={{backgroundColor: 'white'}} />
        <ListItemButton sx={{ marginBottom: '5px', marginTop: '5px', color: 'white' }} onClick={() => history.push('/')}>
        ...
        <Divider sx={{backgroundColor: 'white'}} />
        <ListItemButton sx={{ marginTop: '5px', color: 'white' }} onClick={() => history.push('/')}>
          Employees
        </ListItemButton>
        <Divider sx={{backgroundColor: 'white'}} />
        <ListItemButton sx={{ marginTop: '5px', color: 'white' }} onClick={() => history.push('/')}>
